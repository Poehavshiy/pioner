...
QT_MOC_LITERAL(5, 48, 11), // "ClearWindow"
QT_MOC_LITERAL(6, 60, 21) // "mouseDoubleClickEvent"

    },
    "MyQGraphicsView\0mousePressEvent\0\0"
    "QMouseEvent*\0e\0ClearWindow\0"
...
void MyQGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MyQGraphicsView *_t = static_cast<MyQGraphicsView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject MyQGraphicsView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_MyQGraphicsView.data,
      qt_meta_data_MyQGraphicsView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MyQGraphicsView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyQGraphicsView.stringdata0))
        return static_cast<void*>(const_cast< MyQGraphicsView*>(this));
